...
let endPoint="http://localhost:1200/Rental"
...
export default function Rental() {
  ...
  useEffect(() => {
    ...
    // })
    const deletedata = (id)=> {
      axios.delete(`http://localhost:1200/Rental/${id}`).then((response) => {
        getalldata()
      ...
      try {
        if (isEdit) {
          let mainobj={
            ...
            price:RenterObj.price,


            Squarefeet:RenterObj.Squarefeet,
          ...
          <Modal
                      ...
                      <Col  md="6" >
                                    <FormGroup className="mb-3">
                                      ...
                                      <AvField
                                        name="Squarefeet"
                                        placeholder="Enter your Squarefeet"
                                        type="text"
                                        value={RenterObj.Squarefeet}
                                        onChange={e => hundleChange(e)}
                                        errorMessage="Enter the Squarefeet"
                                        className="form-control"
                                        validate={{ required: { value: true } }}
                                        id="validationCustom02"
                                      >
